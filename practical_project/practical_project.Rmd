...
ssls_parleft_model <- stan_glmer(hqual ~ sexmf + parleft + parsc_enc + (1 + parleft|schoolid), 
                                 data = ssls_data, family = binomial, seed = 123, iter = 4000, warmup = 2000)
print(Sys.time()-start_time)
...
```{r models for variance in explanatory variables (without parsc)}
start_time <- Sys.time()
ssls_parsc_model <- stan_glmer(hqual ~ sexmf + parleft + (1 + parsc_enc|schoolid), 
                               data = ssls_data, family = binomial, seed = 123, iter = 4000, warmup = 2000)
print(Sys.time()-start_time)
